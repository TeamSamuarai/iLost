...
@objc class FloorplanOverlay: NSObject, MKOverlay {
    ...
    */
    ...
    private var pdfDoc: CGPDFDocumentRef
    ...
    */
    ...
    private var pdfBoxRectangle = CGRect.null
    ...
    */
    init(floorplanUrl: NSURL, withPDFBox pdfBox: CGPDFBox, andAnchors anchors: GeoAnchorPair, forFloorLevel level: NSInteger) {
        ...
        */
        pdfDoc = CGPDFDocumentCreateWithURL(floorplanUrl)!
        ...
        */
        ...
        pdfBoxRectangle = CGPDFPageGetBoxRect(pdfPage, pdfBox)
    ...
    */
    func getFloorplanUprightMKMapCameraHeading() -> CLLocationDirection {
        ...
        */
        let pdfPageDictionaryRotationEntryDegrees = CGPDFPageGetRotationAngle(pdfPage)
    ...
    */
    func polygonFromCustomPDFPath(pdfPath: [CGPoint]) -> MKPolygon {
    ...
    */
    ...
    var pdfOrigin: MKMapPoint {
        return coordinateConverter.MKMapPointFromPDFPoint(CGPointZero)
    }
